...
namespace ABC_Car_Traders.Customer
{
    public partial class Cars_View : Form
    {
        ...
        private void modelComBx_SelectedIndexChanged_1(object sender, EventArgs e)
        {
        ...
        private void CarsViewListView_SelectedIndexChanged(object sender, EventArgs e)
        {
